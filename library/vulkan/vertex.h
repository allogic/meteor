...
#define INTERFACE_VERTEX_STRUCT { \
	xVec3_t xPosition; \
	xVec2_t xUv; \
	xVec4_t xColor; \
}
...
#pragma pack(push, 1)
	...
	typedef struct INTERFACE_VERTEX_STRUCT xInterfaceVertex_t;
...
#pragma pack(pop)
	...
	typedef struct __attribute__((packed)) INTERFACE_VERTEX_STRUCT xInterfaceVertex_t;
